import { compareManifests, Change } from './compareManifests'
...
describe(compareManifests, () => {
  it(`returns zero changes when no things changed`, async () => {
    expect(
      compareManifests({ currentManifest: '', previousManifest: '' })
    ).toEqual([])
  ...
  it('correctly picks up things being removed', () => {
    ...
    expect(
      ...
      changes({ type: 'removal', value: 'b' }, { type: 'removal', value: 'c' })
    )
  ...
  it(`correctly picks up things being added`, async () => {
    ...
    expect(
      ...
      changes(
        { type: 'addition', value: 'b' },
        { type: 'addition', value: 'c' }
      )
    )
  ...
  it(`correctly picks up things being modified`, async () => {
    ...
    expect(
      ...
      changes(
        { type: 'modification', value: 'a' },
        { type: 'modification', value: 'b' }
      )
    )
  })
})
